...
if __name__== "__main__":
    ...
    train_loader, test_loader, val_loader = prepare_TUEV_dataloader(sampling_rate=sampling_rate, 
                                                                    batch_size=batch_size, num_workers=num_workers)
    
     
    version = f"TUEV-st_transformer-{lr}-{batch_size}-{sampling_rate}-{num_workers}-{total_epochs}"
    ...
    # save the model
    torch.save(lightning_model.model.state_dict(), f"saved_weights/st_transformer_c11s11c5s5.pt")
